// single-instance server in one machine, every xros instance that has ip address and tun device will try create a server instance.
...
// all the clients will exit and let the xros instance to launch a new server instance.
