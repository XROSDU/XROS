...
import { NetworkTypes, Config, Status, Utils, I18nUtils } from 'xros-frontend-lib'
...
onMounted(async () => {
  if (type() === 'android') {
    try {
      ...
      console.error("xros init vpn service done")
    } catch (e: any) {
      console.error("xros init vpn service failed", e)
    }
  }
})
