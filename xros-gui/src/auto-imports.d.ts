...
declare global {
  ...
  const getXROSVersion: typeof import('./composables/network')['getXROSVersion']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly getXROSVersion: UnwrapRef<typeof import('./composables/network')['getXROSVersion']>
