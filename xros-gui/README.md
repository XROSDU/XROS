...
this is a GUI implementation for XROS, based on Tauri2.
...
Java version depend on gradle version specified in (xros-gui\src-tauri\gen\android\build.gradle.kts)
