...
import { Api, Utils } from 'xros-frontend-lib';
...
const loadDevices = async () => {
    ...
    for (const device of (resp || [])) {
        devices.push({
            ...
            xros_version: device.info?.xros_version,
...
<template>
    ...
    <DataTable :value="deviceList" tableStyle="min-width: 50rem" :metaKeySelection="true" sortField="hostname"
        ...
        <Column field="xros_version" header="XROS Version" sortable style="width: 150px"></Column>
