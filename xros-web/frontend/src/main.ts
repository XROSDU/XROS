...
import 'xros-frontend-lib/style.css'
import './style.css'
import App from './App.vue'
import XROSFrontendLib from 'xros-frontend-lib'
...
).use(ToastService as any).use(DialogService as any).use(router).use(ConfirmationService as any).use(XROSFrontendLib).mount('#app')
