...
use xros::launcher::NetworkConfig;
use xros::proto::common::Void;
use xros::proto::rpc_types::controller::BaseController;
use xros::proto::web::*;
...
struct ListNetworkInstanceIdsJsonResp {
    running_inst_ids: Vec<xros::proto::common::Uuid>,
    disabled_inst_ids: Vec<xros::proto::common::Uuid>,
}
